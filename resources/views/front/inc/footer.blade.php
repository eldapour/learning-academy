            ...
            <div class="col-sm-6 col-md-4 col-xl-4">
                <div class="single-footer-widget footer_2">
                    ...
                    <div class="social_icon">
                        ...
                        <a href="{{ $sett->twitter }}" target="_blank"> <i class="ti-twitter-alt"></i> </a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <p class="footer-text m-0"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://www.facebook.com/ELDAPOUR/" target="_blank">AM</a>
